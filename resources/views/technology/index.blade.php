                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('technologies.destroy',$technology->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('technologies.show',$technology->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('technologies.edit',$technology->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
