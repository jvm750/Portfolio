            ...
            <div class="container" style="color: white; ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent"  >
                    ...
                    @if (Route::has('login'))
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" style="color: white; border: none; cursor: pointer; transition: color 0.3s, font-size 0.3s; font-size: 16px;" onmouseover="this.style.color='#1BBC9D'; this.style.fontSize='120%'" onmouseout="this.style.color='white'; this.style.fontSize='16px'" href="{{ route('areas.index') }}">{{ __('Areas') }}</a>
                                </li>
                     @endif
                    </ul>
