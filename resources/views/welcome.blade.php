...
@foreach ($proyectos as $proyecto)							
                                            ...
                                            <div class="modal-dialog modal-xl" >
                                                <div class="modal-content" style="background-color:#242629;">
                                                        ...
                                                        <div class="container" >
                                                            <div class="row justify-content-center" > 
                                                                <div class="col-lg-8">
                                                                    ...
                                                                    <h2 class="portfolio-modal-title  text-uppercase mb-0" style="color:#1BBC9D;">{{ $proyecto->nombre }}</h2>
                                                                    <!-- Icon Divider-->
                                                                    ...
                                                                    <p class="mb-4"  style="color:white;">{{ $proyecto->descripcion }}</p>
